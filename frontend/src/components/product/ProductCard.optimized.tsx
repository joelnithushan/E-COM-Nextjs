    ...
    >
      ...
      <div className="p-4 flex-1 flex flex-col">
        ...
        {product.ratings.count > 0 && (
          <div className="flex items-center gap-1 mb-2" aria-label={`Rating: ${product.ratings.average} out of 5 stars`}>
        ...
        <div className="mt-auto flex items-baseline gap-2">
          ...
          {hasDiscount && (
            <span className="text-sm text-gray-500 line-through" aria-label={`Original price: ${formatCurrency(product.compareAtPrice!)}`}>
